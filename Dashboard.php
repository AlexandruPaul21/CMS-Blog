...
<body>
    ...
    <section class="container py-2 mb-4">
        <div class="row">
            <div class="col-lg-2" style="min-height:717px">
                <?php 
                    $sql="SELECT * FROM admins";
                    $sol=$ConnectingDB->query($sql);
                    $adm=0;
                    while($Data=$sol->fetch()){
                        $adm=$adm+1;
                    }
                ...
                <div class="card bg-dark text-center" style="min-height:20%;border-radius:20px">
                    <div class="card-body">
                        <h1><i class="fas fa-blog" style="color:white"></i><br></h1>
                        <h5 style="color:white">Posts<br><?php echo $pst; ?></h5>
                    </div>
                </div>
                </a>
                <br>
                ...
                <div class="card bg-dark text-center" style="min-height:20%;border-radius:20px">
                    <div class="card-body">
                        <h1><i class="fas fa-users" style="color:white"></i><br></h1>
                        <h5 style="color:white">Admins<br><?php echo $adm; ?></h5>
                    </div>
                </div>
                </a>
                <br>
                ...
                <div class="card bg-dark text-center" style="min-height:20%;border-radius:20px">
                    <div class="card-body">
                        <h1><i class="fas fa-comments" style="color:white"></i><br></h1>
                        <h5 style="color:white">Comments<br><?php echo $com; ?></h5>
                    </div>
                </div>
                </a>
                <br>
                ...
                <div class="card bg-dark text-center" style="min-height:20%;border-radius:20px">
                    <div class="card-body">
                        <h1><i class="far fa-bookmark" style="color:white"></i><br></h1>
                        <h5 style="color:white">Categories<br><?php echo $cat; ?></h5>
                    </div>
                </div>
                </a>
                <br>
                    ...
                    <?php
                        ...
                        while($DataRows=$stmt->fetch()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="FullPost.php?Id=<?php echo $Id; ?>" target="_blank"><span class="btn btn-primary">View Post</span></a>           
                                </td>
                            </tr>
                            </tbody>
                        <?php } ?>
